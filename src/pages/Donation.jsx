        ...
        <div className="bg-warm-50 min-h-screen py-10 px-4">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-saffron/30 overflow-hidden mb-16 flex flex-col md:flex-row">
                    ...
                    <div className="md:w-1/2 p-8 lg:p-12 flex flex-col justify-center bg-gradient-to-br from-white to-orange-50/30">
                        ...
                        <h2 className="text-3xl lg:text-4xl font-serif font-bold text-maroon mb-4 leading-tight">
                            Hanuman Janmotsav & 3-Day Mahotsav (Bhandara)
                        </h2>
                        <p className="text-gray-600 mb-8 text-lg">
                            We invite you to participate in the grand 3-day Mahotsav on 22, 23, and 24 April 2026. Contribute towards the Mahaprasadi (Bhandara) by donating essential grocery and vegetable items or contributing cash.
                        </p>
                        ...
                        <div className="space-y-5 mb-8 bg-white p-6 rounded-xl border border-saffron/20 shadow-sm">
                            <div className="flex items-start">
                                ...
                                <div>
                                    <h4 className="font-bold text-maroon text-lg">Event Dates</h4>
                                    <p className="text-gray-600 mt-0.5">22, 23, and 24 April 2026</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start">
                                ...
                                <div>
                                    <h4 className="font-bold text-maroon text-lg">Contact Mandir Counter</h4>
                ...
                <div id="payment-options" className="flex items-center gap-4 mb-8">
                    ...
                    <h3 className="text-2xl font-serif font-bold text-maroon px-4">Other General Donation Options</h3>
                    <div className="h-px bg-gray-300 flex-1"></div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 mb-12">
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-xl border border-saffron/20 relative overflow-hidden">
                        ...
                        <div className="space-y-4">
                            ...
                            <button className="w-full py-3 rounded-lg border-2 border-gray-200 font-medium hover:border-saffron hover:bg-orange-50 transition-colors">₹ 501 - Tea Seva</button>
                            <button className="w-full py-3 rounded-lg border-2 border-gray-200 font-medium hover:border-saffron hover:bg-orange-50 transition-colors">₹ 1100 - Prasadi</button>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-xl border border-maroon/20">
                        ...
                        <div className="bg-gray-50 p-6 rounded-xl space-y-3 text-sm border border-gray-200">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="font-bold text-gray-800">UNION BANK OF INDIA</span>
                            </div>
                            <div className="flex justify-between">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="font-bold text-gray-800">Modasa</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-xl border border-saffron/20 h-full flex flex-col">
                        ...
                        <h2 className="text-2xl font-bold text-center text-maroon mb-4">Scan & Donate</h2>
                        <p className="text-center text-gray-500 mb-8 text-sm">Use any UPI app to scan and make a donation.</p>
